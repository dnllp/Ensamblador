__CONFIG _CP_OFF & _WDT_OFF & _PWRTE_ON & _XT_OSC
				...
				;desplazando a la derecha, por la izquierda entra un 0
INCLUDE <P16F84A.INC>
				;Por el puerto B se obtiene el dato del puerto A con las instrucción rrf
				;se debe colocar un 0 en el carry (C) del registro STATUS ya que este entra
				;por la derecha
ORG 0 			;Con esta instruccion decimos que va a grabar el programa a partir de la direcci?n 0
	...
	bcf STATUS,RP0	;Salimos de configuraci?n, pasamos del banco 1 al banco 0

Inicio				;Etiqueta que marca el inicio del programa
	bcf STATUS,C	;Colocamos un 0 en el Carry (C) del registro
	rrf PORTA,W 	;se recorren los bits a la derecho del puerto A, el resultado queda en W
